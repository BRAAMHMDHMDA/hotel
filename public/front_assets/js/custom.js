(function($) {
    ...
    //         // Custom action on date selection
    //         // $("#date-display").text("Selected date: " + dateText);
    ...
    //     onSelect: function(dateText, inst) {
    //         let endDate = $('#endDate');
    //         let minDateForEndDate = new Date(inst.selectedYear, inst.selectedMonth - 1, inst.selectedDay);
    //         let selectedDay = (parseInt(inst.selectedDay, 10) + 1).toString();
    //
    //         endDate.datepicker("option", "minDate", new Date(inst.selectedYear, inst.selectedMonth + 1, selectedDay ));
    //         endDate.val('');
    //         $("#checkIn").val = dateText;
    //         var livewireVar = $wire.checkIn;
    //         console.log($wire.$get('checkIn'))
    //     }
    // });
    //
