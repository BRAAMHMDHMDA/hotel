...
final class Index extends PowerGridComponent
{
    ...
    public function fields(): PowerGridFields
    {
        return PowerGrid::fields()
            ->add('id')
            ->add('title')
            ->add('preview' , fn ($post) => '<img class="img-thumbnail me-2" style="height: 50px;" src="'.$post->image_url.'" alt="Image"><a target="_blank" href="/blog/posts/'.$post->slug.'">'.$post->title.'</a>')
            ->add('image_path')
